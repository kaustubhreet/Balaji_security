...
/* { 
    "email": "careeragencytech@gmail.com"
}
*/
...
const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await axios.post(`${backendUrl}/admin/auth/forget-password`, formData);
        ...
        <h2 className="text-center mb-4">Forget Password👋</h2>
           <form onSubmit={handleSubmit}>
            ...
            <div className="gap-2" style={{marginInline:"10px"}}>
                ...
                <button type="cancel" onClick={() => navigate("/ad_login")} className="btn btn-primary" style={{ alignContent: "center", fontSize: "20px" }} >
                    Go Back
                </button>
            </div>
        </form>
...
export default Ad_forgetPassword