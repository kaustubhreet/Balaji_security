...
const PositionEquity = () => {
  ...
  const handleDelete = (id) => {
    axios.delete(`${backendUrl}/positionHoldingApi/positionEquity/${id}`).then((response) => {
  ...
  <h1 style={{marginBlock:"30px",alignItems:"center"}}>POSITIONS EQUITY </h1>
